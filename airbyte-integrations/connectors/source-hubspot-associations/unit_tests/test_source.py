...
from source_hubspot_associations.errors import HubspotRateLimited, InvalidStartDateConfigError
from source_hubspot_associations.helpers import APIv3Property
from source_hubspot_associations.source import SourceHubspot
from source_hubspot_associations.streams import API, Companies, Deals, Engagements, MarketingEmails, Products, Stream
...
@mock.patch("source_hubspot_associations.source.SourceHubspot.get_custom_object_streams")
